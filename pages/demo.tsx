...
export default function DemoPage() {
  ...
  return (
    <>
      <AnimatePresence>
        {step === 3 ? (
          <div className="w-full min-h-screen flex flex-col px-4 pt-2 pb-8 md:px-8 md:py-2 bg-[#121212] relative overflow-x-hidden">
              ...
              <div className="w-full flex flex-col max-w-[1080px] mx-auto mt-[10vh] overflow-y-auto pb-8 md:pb-12">
                ...
                >
                  <div className="flex flex-row items-center space-x-1">
                    ...
                    <p className="text-[14px] font-normal leading-[20px] text-gray-300">
                  ...
                  <Link
                    ...
                    target="_blank"
                    className="group rounded-full pl-[8px] min-w-[180px] pr-4 py-2 text-[13px] font-semibold transition-all flex items-center justify-center bg-[#1E2B3A] text-white hover:bg-[#2D3B4A] no-underline gap-x-2 active:scale-95 scale-100 duration-75"
                    style={{
                      boxShadow:
                ...
                >
                  <div>
                    <h2 className="text-xl font-semibold text-left text-gray-200 mb-2">Transcript</h2>
                    <p className="prose prose-sm max-w-none text-gray-300">
                      {transcript.length > 0 ? transcript : "Don't think you said anything. Want to try again?"}
                    </p>
                  </div>
                  <div className="mt-8">
                    <h2 className="text-xl font-semibold text-left text-gray-200 mb-2">Feedback</h2>
                    <div className="mt-4 text-sm flex gap-2.5 rounded-lg border border-gray-700 bg-[#1A1A1A] p-4 leading-6 text-gray-300 min-h-[100px]">
              ...
              <div className="h-full w-full items-center flex flex-col mt-[10vh]">
                {recordingPermission ? (
                  <div className="w-full flex flex-col max-w-[1080px] mx-auto justify-center">
                    <h2 className="text-2xl font-semibold text-left text-gray-200 mb-2">
                      {selected.name === "Behavioral"
                        ? `Tell me about yourself. Why don${`'`}t you walk me through your resume?`
                        : selectedInterviewer.id === "John"
                                ...
                                <div className="flex flex-row gap-2">
                                  {!isSubmitting && (
                                    <button
                                      ...
                                      className="group rounded-full px-4 py-2 text-[13px] font-semibold transition-all flex items-center justify-center bg-gray-800 text-white hover:bg-gray-700 no-underline gap-x-2 active:scale-95 scale-100 duration-75"
                                    >
                                      Restart
                                    </button>
                                  )}
                                  <button
                                    ...
                                    className="group rounded-full min-w-[140px] px-4 py-2 text-[13px] font-semibold transition-all flex items-center justify-center bg-[#1E2B3A] text-white hover:bg-[#2D3B4A] no-underline active:scale-95 scale-100 duration-75 disabled:cursor-not-allowed"
                                    style={{
                                      boxShadow:
                                        "0px 1px 4px rgba(13, 34, 71, 0.17), inset 0px 0px 0px 1px #061530, inset 0px 0px 0px 2px rgba(255, 255, 255, 0.1)",
                                    }}
                              ...
                              <div className="lg:mt-4 flex flex-col items-center justify-center gap-2">
                                {capturing ? (
                                  ...
                                  <button
                                    ...
                                    className="flex h-8 w-8 sm:h-8 sm:w-8 flex-col items-center justify-center rounded-full bg-red-500 text-white hover:shadow-xl ring-4 ring-white ring-offset-gray-800 ring-offset-2 active:scale-95 scale-100 duration-75"
                                  ></button>
                                )}
                  ...
                  <div className="w-full flex flex-col max-w-[1080px] mx-auto justify-center">
                    ...
                    <div className="flex flex-row space-x-4 mt-8 justify-end">
                      <button
                        onClick={() => setStep(1)}
                        className="group max-w-[200px] rounded-full px-4 py-2 text-[13px] font-semibold transition-all flex items-center justify-center bg-gray-800 text-white no-underline active:scale-95 scale-100 duration-75"
                        style={{
          ...
          <div className="flex flex-col md:flex-row w-full md:overflow-hidden">
            <div className="w-full min-h-[60vh] md:w-1/2 md:h-screen flex flex-col px-4 pt-2 pb-8 md:px-0 md:py-2 bg-[#121212] justify-center">
              <div className="h-full w-full items-center justify-center flex flex-col">
                {step === 0 ? (
                  ...
                  >
                    <h2 className="text-4xl font-bold text-gray-200">Select a question type</h2>
                    <p className="text-[14px] leading-[20px] text-gray-400 font-normal my-4">
                            ...
                            <RadioGroup.Option
                              ...
                              className={({ checked, active }) =>
                                classNames(
                                  ...
                                  active ? "border-blue-500 ring-2 ring-blue-800" : "",
                                  "relative cursor-pointer rounded-lg border bg-[#1A1A1A] px-6 py-4 shadow-sm focus:outline-none flex justify-between",
                                )
                              }
                            >
                              {({ active, checked }) => (
                    ...
                    <div className="flex gap-[15px] justify-end mt-8">
                      <div>
                        <button
                          onClick={() => setStep(0)}
                          className="group rounded-full px-4 py-2 text-[13px] font-semibold transition-all flex items-center justify-center bg-gray-800 text-white no-underline active:scale-95 scale-100 duration-75"
                          style={{
                            boxShadow: "0 1px 1px #0c192714, 0 1px 3px #0c192724",
                          }}
                        >
                      ...
                      <div>
                        <button
                          ...
                          className="group rounded-full px-4 py-2 text-[13px] font-semibold transition-all flex items-center justify-center bg-[#1E2B3A] text-white hover:bg-[#2D3B4A] no-underline gap-x-2 active:scale-95 scale-100 duration-75"
                          style={{
                            boxShadow:
                              "0px 1px 4px rgba(13, 34, 71, 0.17), inset 0px 0px 0px 1px #061530, inset 0px 0px 0px 2px rgba(255, 255, 255, 0.1)",
                          }}
                  ...
                  <motion.div
                    ...
                    className="max-w-lg mx-auto px-4 lg:px-0"
                  >
                    <h2 className="text-4xl font-bold text-gray-200">And an interviewer</h2>
                    <p className="text-[14px] leading-[20px] text-gray-400 font-normal my-4">
            ...
            <div className="w-full h-[40vh] md:w-1/2 md:h-screen bg-[#0A0A0A] relative overflow-hidden">
              <svg
                id="texture"
                style={{ filter: "contrast(120%) brightness(70%)" }}
              ...
              >
                <filter id="noise" data-v-1d260e0e="">
                  <feTurbulence
                    ...
                    data-v-1d260e0e=""
                  ></feTurbulence>
                  <feColorMatrix type="saturate" values="0" data-v-1d260e0e=""></feColorMatrix>
                </filter>
                <rect width="100%" height="100%" filter="url(#noise)" data-v-1d260e0e=""></rect>
              </svg>
              <figure
                className="absolute md:top-1/2 ml-[-380px] md:ml-[0px] md:-mt-[240px] left-1/2 grid transform scale-[0.5] sm:scale-[0.6] md:scale-[130%] w-[760px] h-[540px] bg-[#1A1A1A] text-[9px] origin-[50%_15%] md:origin-[50%_25%] rounded-[15px] overflow-hidden p-2 z-20"
                style={{
                  grid: "100%/repeat(1,calc(5px * 28)) 1fr",
                  boxShadow:
                    "0 192px 136px rgba(0,0,0,.3),0 70px 50px rgba(0,0,0,.26),0 34px 24px rgba(0,0,0,.23),0 17px 12px rgba(0,0,0,.2),0 7px 5px rgba(0,0,0,.17), 0 50px 100px -20px rgb(0 0 0 / 35%), 0 30px 60px -30px rgb(0 0 0 / 40%), inset 0 -2px 6px 0 rgb(10 37 64 / 35%)",
                }}
              >
                <div className="z-20 absolute h-full w-full bg-transparent cursor-default"></div>
                <div
                  className="bg-[#1A1A1A] flex flex-col text-gray-300 p-[18px] rounded-lg relative"
                  style={{ boxShadow: "inset -1px 0 0 #2A2A2A" }}
                >
                  <ul className="mb-auto list-none">
                    ...
                    <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-300 py-[4px]">
                      <svg fill="none" viewBox="0 0 24 24" className="h-4 w-4 text-gray-400">
                        <path
                          stroke="currentColor"
                          strokeLinecap="round"
                          strokeLinejoin="round"
                      ...
                      <div className="ml-auto text-gray-300 transform">
                        <svg
                          width="24"
                          height="24"
                          fill="none"
                    ...
                    <li className="mt-1 list-none flex items-center rounded-[3px] relative bg-[#1A1A1A] text-gray-400 w-full m-0 cursor-pointer hover:bg-[#252525] focus:outline-none py-[4px]">
                      <div className="bg-[#444444] pointer-events-none absolute left-[7px] z-10 top-1/2 h-[3px] w-[3px] rounded-full transform -translate-y-1/2"></div>
                      <div className="text-gray-400 truncate pr-4 pl-[18px]">All Interviews</div>
                      <div className="absolute w-[1px] bg-[#444444] left-[8px] top-[9px] bottom-0"></div>
                    </li>
                    <li className="list-none flex items-center rounded-[3px] relative bg-[#1A1A1A] text-gray-400 w-full m-0 cursor-pointer hover:bg-[#252525] focus:outline-none py-[4px]">
                      <div className="bg-[#444444] pointer-events-none absolute left-[7px] z-10 top-1/2 h-[3px] w-[3px] rounded-full transform -translate-y-1/2"></div>
                      <div className="text-gray-400 truncate pr-4 pl-[18px]">Completed</div>
                      <div className="absolute w-[1px] bg-[#444444] left-[8px] top-0 bottom-0"></div>
                    </li>
                    <li className="list-none flex items-center rounded-[3px] relative bg-[#252525] text-gray-400 w-full m-0 cursor-pointer hover:bg-[#252525] focus:outline-none py-[4px]">
                      <div className="bg-[#444444] pointer-events-none absolute left-[7px] z-10 top-1/2 h-[3px] w-[3px] rounded-full transform -translate-y-1/2"></div>
                      <div className="text-blue-400 truncate pr-4 pl-[18px]">Question Bank</div>
                      <div className="absolute w-[1px] bg-[#444444] left-[8px] top-0 bottom-[9px]"></div>
                    </li>
                    <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-300 py-[4px]">
                      <svg className="h-4 w-4 text-gray-400" fill="none" viewBox="0 0 24 24">
                        <path
                  ...
                  <ul className="flex flex-col mb-[10px]">
                    ...
                    <li className="mt-1 list-none flex items-center rounded-[9px] text-gray-300 py-[2px]">
                      ...
                      <p className="ml-[4px] mr-[6px] flex-shrink-0">Vikrant</p>
                ...
                <div className="bg-[#1A1A1A] text-gray-400 p-[18px] flex flex-col">
                  {step === 1 ? (
                    <div>
                      <motion.span
                        initial={{ opacity: 0, y: 10 }}
                        ...
                        key={selected.id}
                        className="text-gray-200 text-[14px] leading-[18px] font-semibold absolute"
                      >
                      ...
                      <ul className="mt-[28px] flex">
                        <li className="list-none max-w-[400px]">
                          Search through all of the questions in the question bank. If you don{`'`}t see one you{`'`}re
                          looking for, you can always add it in your the {`"`}My Questions
                          {`"`} section.
                        </li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <ul className="mt-[28px] flex">
                        {selected.name === "Behavioral" ? (
                          <li className="list-none max-w-[400px]">
                            Start off by walking me through your resume. Perhaps begin with your internships in college
                            and move to more recent projects.
                          </li>
                        ) : (
                          <li className="list-none max-w-[400px]">
                            Start off by explaining what the function does, and its time and space complexities. Then go
                            into how you would optimize it.
                          </li>
                        )}
                      </ul>
                    </div>
                  ...
                  {step === 2 && (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: -10 }}
                      transition={{ duration: 0.5, ease: [0.23, 1, 0.32, 1] }}
                      className="mt-[12px] flex bg-[#252525] h-[80%] rounded-lg relative ring-1 ring-gray-900/5 shadow-md"
                    >
                      {selectedInterviewer.id === "John" ? (
                        <motion.img
                          initial={{ opacity: 0, y: 10 }}
                      ...
                      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 translate-y-1/2 w-8 h-8 md:w-12 md:h-12 bg-red-400 ring-4 ring-[#1A1A1A] rounded-full"></div>
                    </motion.div>
                  )}
                  {step === 1 && (
                        ...
                        <li className="list-none relative flex items-stretch text-left">
                          <div className="group relative w-full">
                            <div className="relative mb-2 flex h-full max-h-[200px] w-full cursor-pointer items-start justify-between rounded-lg p-2 font-medium transition duration-100">
                              <div className="absolute inset-0 rounded-lg ring-1 ring-inset ring-gray-700 group-hover:ring-gray-600"></div>
                              <div className="relative flex h-full flex-col overflow-hidden">
                                <div className="flex items-center text-left text-gray-200">
                                  <p>Why this company?</p>
                                </div>
                                <p className="text-wrap grow font-normal text-[7px] text-gray-400">
                                  Why do you want to work for Google?
                                </p>
                                <div className="flex flex-row space-x-1">
                                  <p className="inline-flex items-center justify-center truncate rounded-full border-[0.5px] border-gray-600 px-[3px] text-[7px] font-normal hover:bg-gray-800">
                                    Product Management
                                  </p>
                                  <p className="inline-flex items-center justify-center truncate rounded-full border-[0.5px] border-[#2A4A36] bg-[#1A2A1F] px-[3px] text-[7px] font-normal hover:bg-[#1F3526]">
                          ...
                          <div className="group relative w-full">
                            <div className="relative mb-2 flex h-full max-h-[200px] w-full cursor-pointer items-start justify-between rounded-lg p-2 font-medium transition duration-100">
                              ...
                              <div className="relative flex h-full flex-col overflow-hidden">
                                ...
                                <p className="text-wrap grow font-normal text-[7px] text-gray-400">
                                  Walk me through your resume, projects, and anything you feel is relevant to your
                                  story.
                                </p>
                                <div className="flex flex-row space-x-1">
                                  <p className="inline-flex items-center justify-center truncate rounded-full border-[0.5px] border-gray-600 px-[3px] text-[7px] font-normal hover:bg-gray-800">
                          ...
                          <div className="group relative w-full">
                            <div className="relative mb-2 flex h-full max-h-[200px] w-full cursor-pointer items-start justify-between rounded-lg p-2 font-medium transition duration-100">
                              ...
                              <div className="relative flex h-full flex-col overflow-hidden">
                                ...
                                <p className="text-wrap grow font-normal text-[7px] text-gray-400">
                                  Explain in as much detail as you can what this function does, including its time and
                                  space...
                                </p>
                                <div className="flex flex-row space-x-1">
                                  <p className="inline-flex items-center justify-center truncate rounded-full border-[0.5px] border-gray-600 px-[3px] text-[7px] font-normal hover:bg-gray-800">
                          ...
                          <div className="group relative w-full">
                            <div className="relative mb-2 flex h-full max-h-[200px] w-full cursor-pointer items-start justify-between rounded-lg p-2 font-medium transition duration-100">
                              ...
                              <div className="relative flex h-full flex-col overflow-hidden">
                                ...
                                <p className="text-wrap grow font-normal text-[7px] text-gray-400">
                                  Uber is looking to expand its product line and wants your take on how...
                                </p>
                                <div className="flex flex-row space-x-1">
                                  <p className="inline-flex items-center justify-center truncate rounded-full border-[0.5px] border-gray-600 px-[3px] text-[7px] font-normal hover:bg-gray-800">
                                    Product Management
                          ...
                          <div className="group relative w-full">
                            <div className="relative mb-2 flex h-full max-h-[200px] w-full cursor-pointer items-start justify-between rounded-lg p-2 font-medium transition duration-100">
                              ...
                              <div className="relative flex h-full flex-col overflow-hidden">
                                ...
                                <p className="text-wrap grow font-normal text-[7px] text-gray-400">
                                  Given what you know about Twitter, how would you architect it from the ground up?
                                </p>
                                <div className="flex flex-row space-x-1">
                                  <p className="inline-flex items-center justify-center truncate rounded-full border-[0.5px] border-gray-600 px-[3px] text-[7px] font-normal hover:bg-gray-800">
                                    Systems Design
                  ...
                  {step === 1 && (
                    <div className="space-y-2 md:space-y-5 mt-auto">
                      <nav
                        className="flex items-center justify-between border-t border-gray-700 bg-[#1A1A1A] px-1 py-[2px] mb-[10px]"
                      ...
                      >
                        ...
                        <div className="flex flex-1 justify-between sm:justify-end">
                          <button className="relative inline-flex cursor-auto items-center rounded border border-gray-700 bg-[#1A1A1A] px-[4px] py-[2px] font-medium text-gray-300 hover:bg-gray-800 disabled:opacity-50">
                            Previous
                          </button>
                          <button className="relative ml-3 inline-flex items-center rounded border border-gray-700 bg-[#1A1A1A] px-[4px] py-[2px] font-medium text-gray-300 hover:bg-gray-800">
                            Next
                          </button>
                        </div>
                      </nav>
